...
# COMENTÁRIO EM BLOCO >>>>>> SELECIONE AS LINHA E APERTE CTRL + / (NO VSCODE É CTRL + ;)

# IMPRESSÃO MULTILINHAS - Podemos usar """ASPAS TRIPLAS""" para imprimir um bloco de texto:
# print(
# """
# +=============================+
# | Welcome to my game, bro!    |
# +=============================+
# """)
