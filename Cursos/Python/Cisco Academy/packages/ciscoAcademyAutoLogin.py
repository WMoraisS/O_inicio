...
time.sleep(2)
nav.find_element_by_xpath('/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div/form/div[1]/div[2]/div/div[2]/span/input').send_keys('xxxxx')
x = nav.find_element_by_xpath('/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div/form/div[2]/input')
x.click()
time.sleep(2)
nav.find_element_by_xpath('/html/body/div[1]/div[1]/div[2]/div/div[2]/div/div/form/div[1]/div[2]/div[2]/div[2]/span/input').send_keys('xxxxx')
